...
public class Teleesqui extends Remuntador {
    ...
    /**
     * *
     * el constructor de la classe Teleesqui és el mateix que el constructor de
     ...
     */
    public Teleesqui(String nom, String sector, String estat, float velocitatDelVentMax, boolean visibilitat) {
