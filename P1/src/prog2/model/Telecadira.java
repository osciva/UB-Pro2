...
public class Telecadira extends Remuntador {
    ...
    /**
     * *
     * el constructor de la classe Telecadira és el mateix que el constructor de
     ...
     */
    public Telecadira(String nom, String sector, String estat, float velocitatDelVentMax, boolean visibilitat) {
