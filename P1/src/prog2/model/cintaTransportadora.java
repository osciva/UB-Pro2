...
public class cintaTransportadora extends Remuntador {
    ...
    /**
     * *
     * el constructor de la classe cintaTransportadora és el mateix que el
     * constructor de la classe remuntador (és a dir, utilitza els mateixos
     * atributs també) això ho expressem al compilador amb la paraula reservada
     * super
     *
     ...
     */
    public cintaTransportadora(String nom, String sector, String estat, float velocitatDelVentMax, boolean visibilitat) {
