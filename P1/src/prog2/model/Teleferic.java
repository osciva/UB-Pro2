...
public class Teleferic extends Remuntador {
    ...
    /**
     * *
     * el constructor de la classe Teleferic és el mateix que el constructor de
     ...
     */
    public Teleferic(String nom, String sector, String estat, float velocitatDelVentMax, boolean visibilitat) {
